 ...
 */
export const initial_render_and_do_not_expect_validation_error = (
  the_error_not_expected: string,
) => {
  render(<App />);
 ...
 */
export const fill_input_make_empty_expect_validation_error = async (
  placeholder: RegExp,
  value: string,
  errorMsg: string,
) => {
 ...
 */
export const click_checkbox_expect_validation_error = async (
...
module.exports = {
  ...
  click_checkbox_expect_validation_error,
};
